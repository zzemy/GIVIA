...
const newBlock = `                <div className="mt-2 flex flex-wrap items-center gap-3">
                  {onBack && (
                    <button
                      type="button"
                      onClick={onBack}
...
lines.splice(536, 33, newBlock); // 536 is index for line 537. We replace 33 lines.
fs.writeFileSync(file, lines.join('\n'), 'utf8');
console.log("Replaced with Node script using lines.");
