...
export const ANALYSIS_SCHEMA = {
  ...
  fields: {
    ...
    warning: { type: 'string', maxLength: 320 },
    rescueItem: { type: 'string', maxLength: 120 },
    rescueReason: { type: 'string', maxLength: 320 },
    semanticSignals: {
      type: 'array',
      maxItems: 8,
    ...
    packaging: {
      ...
      fields: {
        ...
        colors: { type: 'string', maxLength: 120 },
        materials: { type: 'string', maxLength: 120 },
    ...
    card: {
      ...
      fields: {
        ...
        opener: { type: 'string', maxLength: 160 },
        body: { type: 'string', maxLength: 320 },
        closing: { type: 'string', maxLength: 160 },
      },
    },
  },
} as const
...
export const RISK_ENHANCEMENT_SCHEMA = {
  allowExtra: false,
  fields: {
    semanticExplanation: { type: 'string', maxLength: 320 },
    personalizedMitigation: { type: 'string', maxLength: 320 },
    alternativeFraming: { type: 'string', maxLength: 320 },
    culturalContext: { type: 'string', maxLength: 320 },
    confidence: { type: 'number', min: 0, max: 1 },
  },
} as const
