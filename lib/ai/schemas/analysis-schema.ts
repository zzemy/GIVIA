  ...
  fields: {
    ...
    recognition: {
      ...
      fields: {
        ...
        itemZh: { type: 'string', maxLength: 500 },
        itemEn: { type: 'string', maxLength: 500 },
    ...
    rescueItem: { type: 'string', maxLength: 5000 },
    ...
    packaging: {
      ...
      fields: {
        ...
        colors: { type: 'string', maxLength: 5000 },
        materials: { type: 'string', maxLength: 5000 },
        avoid: { type: 'string', maxLength: 5000 },
      },
    },
    card: {
      type: 'object',
      allowExtra: false,
      fields: {
        tone: { type: 'string', maxLength: 5000 },
        opener: { type: 'string', maxLength: 5000 },
        body: { type: 'string', maxLength: 2500 },
        closing: { type: 'string', maxLength: 5000 },
      },
    },
  },
} as const
