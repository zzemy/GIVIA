...
exports.RISK_ENHANCEMENT_SCHEMA = exports.ANALYSIS_SCHEMA = exports.ANALYSIS_RISK_LEVELS = void 0;
exports.ANALYSIS_RISK_LEVELS = ['Low', 'Medium', 'High'];
exports.ANALYSIS_SCHEMA = {
    ...
    fields: {
        country: {
            type: 'string',
            maxLength: 64,
            enum: ['Japan', 'France', 'United Kingdom', 'United States', 'Saudi Arabia'],
        },
        recognition: {
            type: 'object',
            allowExtra: false,
        ...
        riskLevel: {
            type: 'string',
            enum: exports.ANALYSIS_RISK_LEVELS,
            maxLength: 16,
        },
...
exports.RISK_ENHANCEMENT_SCHEMA = {
    allowExtra: false,
    fields: {
