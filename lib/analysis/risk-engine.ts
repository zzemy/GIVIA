...
import { COUNTRY_RULES, getSceneTemplate } from '@/lib/config/gifting-config'
import type { AnalysisEngineResult, AudienceProfileInput, CountryRule, P0Locale, RecommendationItem } from '@/lib/types/gifting-types'
